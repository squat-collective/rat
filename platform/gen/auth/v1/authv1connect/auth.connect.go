...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/rat-data/rat/platform/gen/auth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceName = "ratatouille.auth.v1.AuthService"
)
...
const (
	...
	// RPC.
	AuthServiceAuthenticateProcedure = "/ratatouille.auth.v1.AuthService/Authenticate"
	// AuthServiceAuthorizeProcedure is the fully-qualified name of the AuthService's Authorize RPC.
	AuthServiceAuthorizeProcedure = "/ratatouille.auth.v1.AuthService/Authorize"
)

// AuthServiceClient is a client for the ratatouille.auth.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the ratatouille.auth.v1.AuthService service. By
...
// Authenticate calls ratatouille.auth.v1.AuthService.Authenticate.
...
// Authorize calls ratatouille.auth.v1.AuthService.Authorize.
...
// AuthServiceHandler is an implementation of the ratatouille.auth.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/ratatouille.auth.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Authenticate(context.Context, *connect.Request[v1.AuthenticateRequest]) (*connect.Response[v1.AuthenticateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ratatouille.auth.v1.AuthService.Authenticate is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Authorize(context.Context, *connect.Request[v1.AuthorizeRequest]) (*connect.Response[v1.AuthorizeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ratatouille.auth.v1.AuthService.Authorize is not implemented"))
}
