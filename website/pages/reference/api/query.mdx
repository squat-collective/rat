...
```json
{
  ...
  "rows": [
    { "id": "ORD-001", "amount": 129.99, "status": "completed", "created_at": "2026-02-12T10:00:00Z" },
    { "id": "ORD-002", "amount": 245.50, "status": "completed", "created_at": "2026-02-12T11:30:00Z" }
  ],
  "total_rows": 10,
  "duration_ms": 45
}
...
| `rows` | `array` | Result rows as objects keyed by column name |
