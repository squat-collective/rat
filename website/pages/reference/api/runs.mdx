...
| `started_after` | `string` | — | Filter runs that started after this ISO 8601 timestamp |
| `started_before` | `string` | — | Filter runs that started before this ISO 8601 timestamp |
  ...
  "runs": [
    {
      ...
      "rows_written": 12340,
      "error": null,
      "logs_s3_path": "default/runs/run-uuid/logs.txt",
...
| `runs[].pipeline_id` | `string` | UUID of the pipeline this run belongs to |
...
| `runs[].error` | `string\|null` | Error message if the run failed |
| `runs[].logs_s3_path` | `string\|null` | S3 path to the persisted run logs |
...
```json
{
  ...
  "rows_written": 12340,
  "error": null,
  "logs_s3_path": "default/runs/abc123/logs.txt",
  "created_at": "2026-02-12T14:00:00Z"
}
```
...
|---|---|---|
| `id` | `string` | Run UUID |
| `pipeline_id` | `string` | UUID of the pipeline this run belongs to |
...
| `logs_s3_path` | `string\|null` | S3 path to the persisted run logs |
...
| `error` | `{"code": "...", "message": "..."}` | An error occurred during execution |
