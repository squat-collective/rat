...
## View the Complete Lineage (Plugin)

Lineage is provided by the optional `rat-plugin-lineage` plugin (not part of the core; it is
a free install since RAT is 100% free and open-source — see the [lineage guide](/guides/lineage)).
With it installed, navigate to the **Lineage** page (the plugin registers it at `/x/lineage`).
