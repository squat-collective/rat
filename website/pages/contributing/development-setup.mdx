...
```
NAME        STATUS                  PORTS
postgres    Up 30s (healthy)        127.0.0.1:5433->5432/tcp
minio       Up 30s (healthy)        127.0.0.1:9002->9000/tcp, 127.0.0.1:9003->9001/tcp
...
- Port **8090** (internal listener — unauthenticated service-to-service callbacks; not published to the host in compose)
...
| **MinIO Console** | 9003 | [localhost:9003](http://localhost:9003) | Browsing S3 data |
| **MinIO API (S3)** | 9002 | `localhost:9002` | S3 API access |
| **Nessie** | 19120 | [localhost:19120](http://localhost:19120) | Iceberg catalog debugging |
| **Postgres** | 5433 | `localhost:5433` | Database debugging |
