...
It is 100% free and open-source — one platform, no editions or tiers. Extend it with optional plugins.
</Callout>
...
- **Batteries included** — Editor, scheduler, query console, quality tests — all built-in (and lineage is one install away as a plugin)
...
RAT is built by [Le Squat](https://squat-collective.github.io/website/) — an underground builders collective. 100% free and open-source, no editions or paywalls.
</Callout>
