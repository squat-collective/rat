...
If memory is consistently near the limit, increase `DUCKDB_MEMORY_LIMIT` and the container memory limit. See the [Docker Compose](/self-hosting/docker-compose) page for tuning details.
