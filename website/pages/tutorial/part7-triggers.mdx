...
**Time:** ~15 minutes | **Prerequisites:** [Part 6](/tutorial/part6-python-pipelines) completed (Python pipeline running)
...
- **Bearer Token**: `rat_wh_...` (shown **only once** — copy it now!)
...
```
CSV Upload → launch-data landing zone
       │
       ▼ (landing_zone_upload trigger)
  bronze.mission_log
       │
       ▼ (pipeline_success trigger)
  silver.enriched_launches
       │
       ▼ (pipeline_success trigger — you'll add this in Part 8)
  gold.launch_summary
```
...
<Cards num={1}>
  <Card title="Part 8: Gold Layer & Complete Platform →" href="/tutorial/part8-complete-platform">
