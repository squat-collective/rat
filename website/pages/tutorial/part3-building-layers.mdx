...
**Time:** ~10 minutes | **Prerequisites:** [Part 2](/tutorial/part2-landing-zones) completed (bronze pipelines running)
...
<Cards num={1}>
  <Card title="Part 4: Merge Strategies & Incremental Loading →" href="/tutorial/part4-merge-strategies">
