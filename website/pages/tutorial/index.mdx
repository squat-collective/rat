...
└─────────────┘    └──────────────┘    │                  │    └──────────────────┘
┌─────────────┐    ┌──────────────┐    │                  │    ┌──────────────────┐
│vehicle-ctlg │───▶│rocket_registr│───▶│                  │    │vehicle_stats (py)│
└─────────────┘    └──────────────┘    └──────────────────┘    └──────────────────┘
```
...
<Cards>
  <Card title="Part 1: Your First Pipeline" href="/tutorial/part1-first-pipeline">
    Create a SQL pipeline, preview it, publish it, run it, and query the results. ~15 min
  </Card>
  <Card title="Part 2: Landing Zones" href="/tutorial/part2-landing-zones">
  ...
  <Card title="Part 4: Merge Strategies" href="/tutorial/part4-merge-strategies">
  ...
  <Card title="Part 6: Python Pipelines" href="/tutorial/part6-python-pipelines">
    Write Python pipelines using DuckDB and PyArrow for complex transformations. ~10 min
  </Card>
  <Card title="Part 7: Triggers & Automation" href="/tutorial/part7-triggers">
    Automate pipeline execution with cron, webhooks, and event-driven triggers. ~15 min
  </Card>
  <Card title="Part 8: Complete Platform" href="/tutorial/part8-complete-platform">
