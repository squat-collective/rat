...
// so traffic via /api/v1/x/docs-assistant/* keeps working — but a
// direct peer-to-peer call to http://docs-assistant:50096/... from
...
func main() {
	...
	name := envOr("PLUGIN_NAME", "docs-assistant")
	...
	// /api/v1/x/docs-assistant/*. We wrap it with tokenAuth so a
