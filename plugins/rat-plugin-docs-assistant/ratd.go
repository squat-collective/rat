...
// interconnect broker (capability "ai.chat") — so the docs-assistant never
// hardcodes the AI plugin — and falls back to a direct ai-provider call if
...
// chat returns the assistant's reply text and the model used.
