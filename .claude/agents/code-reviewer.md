...
5. **Docs**: new env vars in `docs/config.md`, new endpoints in `docs/api-spec.md`, an ADR for significant decisions, a migration note for breaking changes — flag anything code-changed-but-docs-didn't.
6. **Blast radius**: migrations, shared infra, anything hard to reverse.
